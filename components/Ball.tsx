...
export const Ball: React.FC<BallProps> = ({ number, delay }) => {
  ...
  return (
    <div 
      className="relative flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-gray-800 to-black border border-neon-purple/30 shadow-[0_0_10px_rgba(188,19,254,0.3)] animate-zoom-in fill-mode-forwards"
